 ...
 */
public class Task3UserIsQuessingAgain {
    ...
    public static void main(String[] args) throws IOException {
        ...
        InputtedNumbers = Sort.quickSort(InputtedNumbers, 0, InputtedNumbers.length);
        output(InputtedNumbers);
    ...
    public static void userPlaysFunGameNow(int array[]) throws IOException {
        ...
        while((inputtedNumber = Integer.parseInt(br.readLine())) > 0) {
            int indexOfFoundNumber = Search.binarySearchInt(array, 0, array.length - 1, inputtedNumber );
