...
public class Task7SearchingForCharInString {
    ...
    public static void main(String[] args) throws IOException{
        ...
        int indexOfBinarySearch = binarySearch(letters, 0, letters.length - 1, yearnedLetter);
        if(indexOfBinarySearch == -1) {
            indexOfBinarySearch = imAGenius(letters,0, letters.length - 1, yearnedLetter);
        }
    ...
    //TODO Zoradenie pola aby binarne vyhladavanie preslo spravne, nie je to velmi dobre riesenie pls oprav to ajked je to blbost lebo ked to opravim binary searchom ziskam 0 casu ale to nevadi
